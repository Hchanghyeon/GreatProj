...
<body>
    <header>
        <a href="/profile/userinfoproc"><i class="fas fa-arrow-left"></i></a>
        <div>계정 정보 수정</div>
    </header>
    <div id="app">
    <section >
        <article>
            <form action="/profile/usereditproc" method="post">
                <div>
                ...
                <div>
                    ...
                    <div>
                        <input type="text" id="nickname" name="nickname" value="${userinfo.nickname}" required>
                    </div>
                </div>
                <div>
                ...
                <div class="add">
                    <input type="text" id="address1" name="address1" placeholder="우편번호" value="${userinfo.address1}" required readonly>
                    <button id="btn" class="btn" type="button" onclick="execPostCode();"><i class="fa fa-search"></i> 우편번호 찾기</button>
                </div>
                <div>
                    <input type="text" id="address2" name="address2" placeholder="도로명 주소" value="${userinfo.address2}" required readonly>
                    <input type="text" id="address3" name="address3" placeholder="상세주소" value="${userinfo.address3}" required>
                </div>
                <div class="submit">
                    <input type="submit" value="계정 정보 수정">
                </div>
            </form>
            <form action="/profile/usereditpwdproc" method="post">
            	<div>
