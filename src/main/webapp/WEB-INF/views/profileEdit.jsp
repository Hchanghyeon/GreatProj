...
<head>
    ...
    <!-- CSS -->
    <link href="${path}/resources/css/profileEdit.css" rel="stylesheet" type="text/css">
    <!-- JQuery -->
...
<body>
    <header>
        <a href="/profile/infoproc"><i class="fas fa-arrow-left"></i></a>
        <div>프로필 수정</div>
    </header>
    <div id="app">
    <section >
        <article>
            <form action="/profile/editprocess" method="post" onsubmit="CheckSubmit();">
                <div>
                    <label for="username">이름</label>
                    <div>
                        <input type="text" id="username" name="username" placeholder="이름을 입력하세요" value="${profileinfo.username}" readonly>
                    </div>
                </div>
                <div>
                    <label for="age">나이</label>
                    <div>
                        <input type="number" id="age" name="age" placeholder="나이를 입력하세요" value="${profileinfo.age}" required>
                    </div>
                </div>
                <div>
                    <label for="height">키</label>
                    <div>
                        <input type="number" id="height" name="height" placeholder="카를 입력하세요" value="${profileinfo.height}" required>
                    </div>
                </div>
                <div>
                ...
                <div>
                    ...
                    <div>
                        <input type="text" id="phone" name="phone" placeholder="핸드폰 번호를 입력하세요" value="${profileinfo.phone}">
                    </div>
                </div>
                <div>
                 ...
                 <div>
                    ...
                    <div class="menudetail">
                        <input type="checkbox" id="korea" name="nation_nm" value="한식" onclick="oneCheckboxNation(this)"/>
                        ...
                        <label for="fusion">퓨전</label>
             			...
             			<input type="hidden" id="nation_value" name="nation_value" value=""/>  
                    </div>
                </div>
                <div id="ingredient">
                    <div class="menu">재료별</div>
                    <div class="menudetail">
                        <input type="checkbox" id="ingre_1" name="ty_nm" value="밥" onclick="oneCheckboxingredient(this)"/>
                        ...
                        <input type="hidden" id="ty_nm_value" name="ty_nm_value" value=""/>
                ...
                <div id="level">
                    ...
                    <div class="menudetail">
                        <input type="checkbox" id="level_1" name="level_nm" value="초보환영" onclick="oneCheckboxlevel(this)"/>
     ...
     const nation_nm = document.getElementById("nation_value");
